    ...
    <>
      ...
      <div className="p-6 pb-2">
        <div className="flex items-center gap-2 mb-1.5">
          <span className="text-[10px] font-bold bg-cyan-500/10 text-cyan-400 px-2 py-0.5 rounded border border-cyan-500/20 uppercase tracking-widest">Base44 Console</span>
        </div>
      ...
      <div className="p-4 mt-auto space-y-3">
        <button
          onClick={() => {
            sessionStorage.setItem('base44_launched', 'false');
            router.push('/');
          }}
          className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/20 transition-all text-xs font-semibold cursor-pointer"
        >
